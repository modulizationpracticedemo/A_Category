...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/modulizationpracticedemo/A_Category"
  ...
  s.source       = { :git => "https://github.com/modulizationpracticedemo/A_Category.git", :tag => s.version.to_s }
